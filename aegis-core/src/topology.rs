...
pub fn verify_against_reference(data: &[u8], reference: &TopologicalShape, threshold: f64) -> VerifyResult {
    let shape = compute_shape(data);
    let distance = shape.distance(reference);
    
    if distance > threshold {
        return VerifyResult::ShapeMismatch { distance, threshold };
    }
...
mod tests {
    ...
    fn test_random_pattern() {
        ...
        let code: [u8; 16] = [0x48, 0x89, 0xe5, 0x48, 0x83, 0xec, 0x10, 0x89,
                              0x7d, 0xfc, 0x8b, 0x45, 0xfc, 0x83, 0xc0, 0x01];
    ...
    fn test_verify_pass() {
        ...
        let prologue = [0x55, 0x48, 0x89, 0xe5, 0x48, 0x83, 0xec, 0x20,
                        0x89, 0x7d, 0xec, 0x89, 0x75, 0xe8, 0x48, 0x89,
                        0x55, 0xe0, 0x48, 0x89, 0x4d, 0xd8, 0x44, 0x89,
                        0x45, 0xd4, 0x44, 0x89, 0x4d, 0xd0, 0x8b, 0x45];
