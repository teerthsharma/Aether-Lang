...
## 2026-07-06 - [Replacing manual iteration in linalg with iterator chains]
...
**Action:** When performing scalar reductions, replace manual loops with iterator chains and ensure shape equality is asserted first.
